...
/**
 * The SimpleLogger class provides a simple logging utility to log messages to the console and to a log file.
 * It supports logging both general messages and error messages, with timestamps for each log entry.
...
public class SimpleLogger {
    ...
    /**
     * Logs an error message to the console and the log file, prefixed with "ERROR:".
     *
    ...
    /**
     * Writes a log message to the log file. If the log file for the current day has changed,
     ...
     * @throws IOException If an error occurs while closing the current log file or opening the new one.
     */
